...
export const db = drizzle(client, { schema: { users, posts, comments, tags, postTags } });
...
export type { Comment, Post, PostTag, Role, Tag, User } from "./schema";
export { comments, posts, postTags, tags, users } from "./schema";
